<div class="container bg-[#F2F3FA] w-full pt-16  md:pt-28 ">
    <div class=" flex   bg-transparent items-center  relative pb-10">
        <div class="relative z-20 flex flex-col gap-2 w-full pb-16  md:w-[600] ">
            ...
            <p class="my-4 text-base  md:text-lg md:leading-[32px]  font-normal text-dark-500 md:w-[562px]">
